...
# Train and evaluate
# -----------------------------------------------------------------------------
print("[SECTION] Sweeping sigmoid kernel hyperparameters (C, gamma, coef0)")
...
for c_value in c_candidates:
    for gamma_value in gamma_candidates:
        for coef0_value in coef0_candidates:
            ...
            print(
                f"Sweep C={c_value}, gamma={gamma_value}, coef0={coef0_value} | "
...
print(
    f"Best kernel params: C={best_c}, gamma={best_gamma}, coef0={best_coef0} "
...
print("[SECTION] Training/evaluating sigmoid SVC with best kernel params")
...
saved_paths = save_model(
    ...
    model_name="geom-svm-kernel-sigmoid",
)
